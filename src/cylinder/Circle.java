...
//constructor with parameter radius of type double and it needs to initialize
// * the fields.
    public Circle(double radius) {//radius parameter is less than 0 it needs to set the radius field value to 0.
        if (radius < 0) {
            this.radius = 0;
        } else {
            this.radius = radius;
